...
after_install = "alphax_master_pos.install.after_install"

doc_events = {
    "AlphaX POS Order": {
        "on_submit": "alphax_master_pos.pos.posting.on_order_submit",
        "on_cancel": "alphax_master_pos.pos.posting.on_order_cancel",
    }
}

scheduler_events = {
    "daily": [
        "alphax_master_pos.pos.maintenance.daily_cleanup",
    ]
}
